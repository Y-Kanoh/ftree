...
require_once 'Familytree_Error.php';
require_once 'Familytree_ActionClass.php';
require_once 'Familytree_ActionForm.php';
require_once 'Familytree_ViewClass.php';
require_once 'Familytree_UrlHandler.php';

/**
 *  Familytree application Controller definition.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Familytree
 */
class Familytree_Controller extends Ethna_Controller
{
    /**#@+
     *  @access protected
     */
    ...
    protected $forward = array(
         ...
         *
         *  'index'         => array(
         *      'view_name' => 'Familytree_View_Index',
         *  ),
         */
    );
    ...
    public $class = array(
        ...
        'form'          => 'Familytree_ActionForm',
        'i18n'          => 'Ethna_I18N',
        'logger'        => 'Ethna_Logger',
        'plugin'        => 'Ethna_Plugin',
        'session'       => 'Ethna_Session',
        'sql'           => 'Ethna_AppSQL',
        'view'          => 'Familytree_ViewClass',
        'renderer'      => 'Ethna_Renderer_Smarty',
        'url_handler'   => 'Familytree_UrlHandler',
    );
